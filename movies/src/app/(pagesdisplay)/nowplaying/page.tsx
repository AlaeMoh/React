...
"use client"
import { fetchPeople, fetchPopularMovies, getImageUrl } from '@/app/services/api';
...
const [nowPlaying, setPlaying] = useState<Movies[]>([])
...
useEffect(()=>{
 const fetchMovieData= async ()=>{
  try{
   const peoplefetch= await fetchPeople()
    setPlaying(peoplefetch)
